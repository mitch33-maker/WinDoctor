...
export const windowsDoctorApi = {
  ...
  startOfflineDiagnosticWork: (body: { component: string; problemText?: string; toolId?: string; execute: boolean; confirmToken?: string }) => apiPost<WorkStatus>("/api/work/offline-diagnostics", body),
